...
| P0.S8 | GitHub Actions: backend, iOS, security, OpenAPI | person_one | — | — | — | All required checks green on a PR | CodeQL + gitleaks + Dependabot | PR #10: Backend, Web, iOS, OpenAPI and Security passed on the hardening source | building | Windows process-lifetime fix awaiting CI verification; add Windows onboarding to the required-check list |
